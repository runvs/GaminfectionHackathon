...
class MyInput
{
	...
	public static var AnyButtonPrressed 		 : Bool;
	...
	public static function update ()
	{
		...
		if (gp != null)
		{
			...
			AnyButtonPrressed = DashButtonJustPressed || JumpButtonJustPressed || InteractButtonPressed || SpecialButtonPressed || InventoryButtonJustPressed || SpaceButtonJustPressed;
